...
struct ServerParams {
	...
	// defaults
	ServerParams() : _port(1235) {}
};

ServerParams readConfig(QString configPath) {
...
int main(int argc, char *argv[])
{
	...
	parser.addPositionalArgument("config", QCoreApplication::translate("main", "Config file path. Default to ./setup.cfg"));
