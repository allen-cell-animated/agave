...
{
public:
  static T* toPointer(QVariant v) { return (T*)v.value<void*>(); }

  static QVariant toVariant(T* pointer) { return qVariantFromValue((void*)pointer); }
};
...
public:
  ...
  static QOpenGLShaderProgram* compileShader(QByteArray vertexShaderSource,
  ...
  static QOpenGLShaderProgram* loadAndCompileShader(QString vsFileName,
                                                    QString fsFileName,
                                                    bool loadVS = true,
                                                    bool loadFS = true);
  static QOpenGLShaderProgram* loadAndCompileShader(QString vsFileName,
