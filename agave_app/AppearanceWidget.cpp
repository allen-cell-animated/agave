  ...
  , m_appearanceObject(cdo)
{
  ...
  QComboBox* rendererType = addRow(*m_appearanceObject->getRendererTypeUiInfo());
  m_MainLayout.addRow("Renderer", rendererType);
  QComboBox* shadingType = addRow(*m_appearanceObject->getShadingTypeUiInfo());
  m_MainLayout.addRow("Shading Type", shadingType);
  QNumericSlider* densityScale = addRow(*m_appearanceObject->getDensityScaleUiInfo());
  m_MainLayout.addRow("Scattering Density", densityScale);
  QNumericSlider* gradientFactor = addRow(*m_appearanceObject->getGradientFactorUiInfo());
  m_MainLayout.addRow("Shading Type Mixture", gradientFactor);
  QNumericSlider* stepSizePrimaryRay = addRow(*m_appearanceObject->getStepSizePrimaryRayUiInfo());
  m_MainLayout.addRow("Step Size Primary Ray", stepSizePrimaryRay);
  QNumericSlider* stepSizeSecondaryRay = addRow(*m_appearanceObject->getStepSizeSecondaryRayUiInfo());
  m_MainLayout.addRow("Step Size Secondary Ray", stepSizeSecondaryRay);
  QCheckBox* interpolateCheckBox = addRow(*m_appearanceObject->getInterpolateUiInfo());
  m_MainLayout.addRow("Interpolate", interpolateCheckBox);
  QColorPushButton* backgroundColorButton = addRow(*m_appearanceObject->getBackgroundColorUiInfo());
  m_MainLayout.addRow("Background Color", backgroundColorButton);
  QCheckBox* showBoundingBoxCheckBox = addRow(*m_appearanceObject->getShowBoundingBoxUiInfo());
  m_MainLayout.addRow("Show Bounding Box", showBoundingBoxCheckBox);
  QColorPushButton* boundingBoxColorButton = addRow(*m_appearanceObject->getBoundingBoxColorUiInfo());
  m_MainLayout.addRow("Bounding Box Color", boundingBoxColorButton);
  QCheckBox* showScaleBarCheckBox = addRow(*m_appearanceObject->getShowScaleBarUiInfo());
