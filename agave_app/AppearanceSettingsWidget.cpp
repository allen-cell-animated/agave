...
const char* cool_array[] = { "#6e40aa", "#6154c8", "#4c6edb", "#368ce1", "#24aad8", "#1ac7c2",
                             "#1ddea3", "#30ee83", "#52f667", "#7ef658", "#7ef658" };
const char* viridis_array[] = { "#440154", "#482475", "#414487", "#355f8d", "#2a788e", "#21908d",
                                "#22a884", "#42be71", "#7ad151", "#bddf26", "#bddf26" };
const char* inferno_array[] = { "#000004", "#160b39", "#420a68", "#6a176e", "#932667", "#ba3655",
                                "#dd513a", "#f3761b", "#fca50a", "#f6d746", "#f6d746" };
const char* magma_array[] = { "#000004", "#140e36", "#3b0f70", "#641a80", "#8c2981", "#b5367a",
                              "#de4968", "#f66e5c", "#fe9f6d", "#fecf92", "#fecf92" };
const char* plasma_array[] = { "#0d0887", "#41049d", "#6a00a8", "#8f0da4", "#b12a90", "#cb4679",
                               "#e16462", "#f1834c", "#fca636", "#fcce25", "#fcce25" };
const char* warm_array[] = { "#6e40aa", "#963db3", "#bf3caf", "#e3419e", "#fe4b83", "#ff5e64",
                             "#ff7747", "#fb9633", "#e2b72f", "#c7d63c", "#c7d63c" };
const char* spectral_array[] = { "#9e0142", "#d13b4b", "#f0704a", "#fcab63", "#fedc8c", "#fbf8b0",
                                 "#e0f3a1", "#aadda2", "#69bda9", "#4288b5", "#4288b5" };
const char* rainbow_array[] = { "#6e40aa", "#be3caf", "#fe4b83", "#ff7747", "#e3b62f", "#b0ef5a",
                                "#53f666", "#1edfa2", "#23acd8", "#4c6fdc", "#4c6fdc" };
const char* cubehelix_array[] = { "#000000", "#1a1530", "#163d4e", "#1f6642", "#53792f", "#a07949",
                                  "#d07e93", "#d09cd9", "#c1caf3", "#d2eeef", "#d2eeef" };
const char* RdYlGn_array[] = { "#a50026", "#d3322b", "#f16d43", "#fcab63", "#fedc8c", "#f9f7ae",
                               "#d7ee8e", "#a4d86f", "#64bc61", "#23964f", "#23964f" };
const char* RdYlBu_array[] = { "#a50026", "#d3322b", "#f16d43", "#fcab64", "#fedc90", "#faf8c0",
                               "#dcf1ec", "#abd6e8", "#76abd0", "#4a74b4", "#4a74b4" };
const char* PuBuGn_array[] = { "#fff7fb", "#efe7f2", "#dbd8ea", "#bfc9e2", "#98b9d9", "#6aa8cf",
                               "#4096c0", "#1987a0", "#047877", "#016353", "#016353" };
const char* YlGnBu_array[] = { "#ffffd9", "#eff9bd", "#d5efb3", "#a9ddb7", "#74c9bd", "#46b4c2",
                               "#2897bf", "#2073b2", "#234ea0", "#1d3185", "#1d3185" };
const char* GnBu_array[] = { "#f7fcf0", "#e5f5df", "#d4eece", "#bde5bf", "#9fd9bb", "#7bcbc4",
                             "#58b7cd", "#399cc6", "#1e7eb7", "#0b60a1", "#0b60a1" };
const char* YlOrRd_array[] = { "#ffffcc", "#fff1a9", "#fee087", "#fec966", "#feab4b", "#fd893c",
                               "#fa5c2e", "#ec3023", "#d31121", "#af0225", "#af0225" };
const char* YlOrBr_array[] = { "#ffffe5", "#fff8c4", "#feeba2", "#fed676", "#febb4a", "#fb9a2c",
                               "#ee7919", "#d85b0a", "#b74304", "#8f3204", "#8f3204" };
const char* RdBu_array[] = { "#67001f", "#ab202e", "#d55f50", "#f0a285", "#fad6c3", "#f2efee",
                             "#cde3ee", "#90c2dd", "#4b94c4", "#2265a3", "#2265a3" };
const char* BuGn_array[] = { "#f7fcfd", "#e8f6f9", "#d5efed", "#b7e4da", "#8fd4c1", "#69c2a3",
                             "#49b17f", "#2f995a", "#157f3c", "#036429", "#036429" };
const char* BuPu_array[] = { "#f7fcfd", "#e4eff5", "#ccddec", "#b2cae1", "#9cb3d5", "#8f95c6",
                             "#8c74b5", "#8952a5", "#852d8f", "#730f71", "#730f71" };
const char* PuBu_array[] = { "#fff7fb", "#efeaf4", "#dbdaeb", "#bfc9e2", "#9cb9d9", "#72a8cf",
                             "#4494c3", "#1b7db6", "#0668a1", "#045281", "#045281" };
const char* RdPu_array[] = { "#fff7f3", "#fde4e1", "#fccfcc", "#fbb5bc", "#f993b0", "#f369a3",
                             "#e03f98", "#c11889", "#99037c", "#710174", "#710174" };
const char* PuRd_array[] = { "#f7f4f9", "#eae3f0", "#dcc9e2", "#d0aad2", "#d08ac2", "#dd63ae",
                             "#e33890", "#d71c6c", "#b80b50", "#8f023a", "#8f023a" };
const char* YlGn_array[] = { "#ffffe5", "#f7fcc4", "#e4f4ac", "#c7e89b", "#a2d88a", "#78c578",
                             "#4eaf63", "#2f944e", "#15793f", "#036034", "#036034" };
const char* OrRd_array[] = { "#fff7ec", "#feebcf", "#fddcaf", "#fdca94", "#fdb07a", "#fa8e5d",
                             "#f16c49", "#e04630", "#c81e13", "#a70403", "#a70403" };
const char* PiYG_array[] = { "#8e0152", "#c0267e", "#dd72ad", "#f0b2d6", "#fadded", "#f5f3ef",
                             "#e1f2ca", "#b7de88", "#81bb48", "#4f9125", "#4f9125" };
const char* PRGn_array[] = { "#40004b", "#722e80", "#9a6daa", "#c1a4cd", "#e3d2e6", "#eff0ef",
                             "#d6eed1", "#a2d79f", "#5dad65", "#217939", "#217939" };
const char* PuOr_array[] = { "#7f3b08", "#b15a09", "#dd841f", "#f8b664", "#fdddb2", "#f3eeea",
                             "#d7d7e9", "#b0aad0", "#8170ad", "#552d84", "#552d84" };
const char* RdGy_array[] = { "#67001f", "#ab202e", "#d55f50", "#f0a285", "#fcd8c4", "#faf4f0",
                             "#dfdfdf", "#b8b8b8", "#868686", "#4e4e4e", "#4e4e4e" };
const char* BrBG_array[] = { "#543005", "#8b530f", "#bc8434", "#ddbd7b", "#f2e4bf", "#eef1ea",
                             "#c3e7e2", "#80c9bf", "#399890", "#0a675f", "#0a675f" };

ColorControlPoint
hexToControlPoint(float t, std::string& hexcolor)
{
  unsigned int r, g, b, a;
  sscanf(hexcolor.c_str(), "#%02x%02x%02x%02x", &r, &g, &b, &a);
  return ColorControlPoint(t, r, g, b, a);
}
std::vector<ColorControlPoint>
stringListToGradient(const char** colors, int n)
{
  std::vector<ColorControlPoint> stops;
  for (int i = 0; i < n; ++i) {
    std::string s(colors[i]);
    stops.push_back(hexToControlPoint(i / (n - 1.0f), s));
  }
  return stops;
}
