...
Download the installer `agave-1.10.0-rc.1-win64.exe` and run it.
...
Download the installer `agave-1.10.0-rc.1-macos-arm64.dmg` and open it.
...
Download the installer `agave-1.10.0-rc.1-macos-x86-64.dmg` and open it.
