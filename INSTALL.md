...
Download the installer `agave-1.9.0-rc.2-win64.exe` and run it.
...
Download the installer `agave-1.9.0-rc.2-macos-arm64.dmg` and open it.
...
Download the installer `agave-1.9.0-rc.2-macos-x86-64.dmg` and open it.
