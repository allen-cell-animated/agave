...
Download the installer `agave-1.9.0-rc.6-win64.exe` and run it.
...
Download the installer `agave-1.9.0-rc.6-macos-arm64.dmg` and open it.
...
Download the installer `agave-1.9.0-rc.6-macos-x86-64.dmg` and open it.
