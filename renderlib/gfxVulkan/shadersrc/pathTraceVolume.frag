...
// per channel
layout(set = 0, binding = 2) uniform sampler2D g_lutTexture[4]; // DEPRECATED to be removed in future stable release
layout(set = 0, binding = 3) uniform sampler2DArray g_colormapTexture;
layout(set = 0, binding = 4) uniform sampler2D tPreviousTexture;

layout(set = 0, binding = 0, std140) uniform PathTraceVolumeParams
{
  Camera gCamera;
  Light gLights[NUM_LIGHTS];
  vec3 gClippedAaBbMin;
  vec3 gClippedAaBbMax;
  float gDensityScale;
  float gStepSize;
...
pathTraceVolumeParams;

#define gCamera pathTraceVolumeParams.gCamera
#define gLights pathTraceVolumeParams.gLights
#define gClippedAaBbMin pathTraceVolumeParams.gClippedAaBbMin
#define gClippedAaBbMax pathTraceVolumeParams.gClippedAaBbMax
#define gDensityScale pathTraceVolumeParams.gDensityScale
#define gStepSize pathTraceVolumeParams.gStepSize
#define gStepSizeShadow pathTraceVolumeParams.gStepSizeShadow
...
#define gInvGradientDelta pathTraceVolumeParams.gInvGradientDelta
#define gGradientFactor pathTraceVolumeParams.gGradientFactor
#define uShowLights pathTraceVolumeParams.uShowLights
#define g_intensityMax pathTraceVolumeParams.g_intensityMax
#define g_intensityMin pathTraceVolumeParams.g_intensityMin
#define g_lutMax pathTraceVolumeParams.g_lutMax
#define g_lutMin pathTraceVolumeParams.g_lutMin
#define g_labels pathTraceVolumeParams.g_labels
#define g_opacity pathTraceVolumeParams.g_opacity
#define g_emissive pathTraceVolumeParams.g_emissive
#define g_diffuse pathTraceVolumeParams.g_diffuse
#define g_specular pathTraceVolumeParams.g_specular
#define g_roughness pathTraceVolumeParams.g_roughness
#define g_tf pathTraceVolumeParams.g_tf
#define g_tf_nNodes pathTraceVolumeParams.g_tf_nNodes
#define uFrameCounter pathTraceVolumeParams.uFrameCounter
#define uSampleCounter pathTraceVolumeParams.uSampleCounter
#define uResolution pathTraceVolumeParams.uResolution
#define g_clipPlane pathTraceVolumeParams.g_clipPlane
