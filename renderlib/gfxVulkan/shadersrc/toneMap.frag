...
layout(set = 0, binding = 0, std140) uniform ToneMapFragParams
{
  float gInvExposure;
}
toneMapFragParams;
layout(set = 0, binding = 1) uniform sampler2D tTexture0;
layout(location = 0) in vec2 vUv;
layout(location = 0) out vec4 out_FragColor;

#define gInvExposure toneMapFragParams.gInvExposure
