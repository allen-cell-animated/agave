...
private:
  ...
  int m_tPreviousTexture, m_uSampleCounter, m_uFrameCounter, m_uResolution, m_gClippedAaBbMin, m_gClippedAaBbMax,
    m_gDensityScale, m_gStepSize, m_gStepSizeShadow, m_gPosToUVW, m_g_nChannels, m_gShadingType, m_gGradientDeltaX,
  ...
  int m_lutTexture0, m_lutTexture1, m_lutTexture2, m_lutTexture3, m_colormapTexture, m_intensityMax, m_intensityMin, 
    m_lutMax, m_lutMin, m_labels, m_opacity, m_emissive0, m_emissive1, m_emissive2, m_emissive3, m_diffuse0, m_diffuse1,
    m_diffuse2, m_diffuse3, m_specular0, m_specular1, m_specular2, m_specular3, m_roughness, m_uShowLights;
  int m_clipPlane;
};
