...
static float CIE_X[nSpectralSamples] = { 0.0253f, 0.0815f, 0.2125f, 0.3243f, 0.3461f, 0.3168f, 0.2480f, 0.1432f,
                                         0.0600f, 0.0160f, 0.0040f, 0.0316f, 0.1113f, 0.2265f, 0.3604f, 0.5127f,
                                         0.6784f, 0.8414f, 0.9761f, 1.0523f, 1.0409f, 0.9351f, 0.7504f, 0.5429f,
                                         0.3625f, 0.2206f, 0.1229f, 0.0648f, 0.0336f, 0.0162f };

static float CIE_Y[nSpectralSamples] = { 0.0007f, 0.0023f, 0.0075f, 0.0170f, 0.0300f, 0.0483f, 0.0744f, 0.1134f,
                                         0.1708f, 0.2608f, 0.4091f, 0.6077f, 0.7909f, 0.9126f, 0.9783f, 0.9983f,
                                         0.9769f, 0.9139f, 0.8153f, 0.6946f, 0.5668f, 0.4415f, 0.3217f, 0.2180f,
                                         0.1392f, 0.0824f, 0.0452f, 0.0236f, 0.0122f, 0.0059f };

static float CIE_Z[nSpectralSamples] = { 0.1202f, 0.3901f, 1.0293f, 1.6036f, 1.7748f, 1.7358f, 1.5092f, 1.0446f,
                                         0.6242f, 0.3585f, 0.2130f, 0.1140f, 0.0582f, 0.0303f, 0.0138f, 0.0059f,
                                         0.0028f, 0.0018f, 0.0014f, 0.0010f, 0.0006f, 0.0002f, 0.0001f, 0.0000f,
                                         0.0000f, 0.0000f, 0.0000f, 0.0000f, 0.0000f, 0.0000f };

static float CIE_lambda[nSpectralSamples] = { 405.0000f, 415.0000f, 425.0000f, 435.0000f, 445.0000f, 455.0000f,
...
static float RGB2SpectLambda[nSpectralSamples] = { 405.0000f, 415.0000f, 425.0000f, 435.0000f, 445.0000f, 455.0000f,
                                                   465.0000f, 475.0000f, 485.0000f, 495.0000f, 505.0000f, 515.0000f,
                                                   525.0000f, 535.0000f, 545.0000f, 555.0000f, 565.0000f, 575.0000f,
                                                   585.0000f, 595.0000f, 605.0000f, 615.0000f, 625.0000f, 635.0000f,
                                                   645.0000f, 655.0000f, 665.0000f, 675.0000f, 685.0000f, 695.0000f };

static float RGBRefl2SpectWhite[nSpectralSamples] = { 1.0617f, 1.0622f, 1.0623f, 1.0625f, 1.0624f, 1.0625f,
...
static float RGBRefl2SpectCyan[nSpectralSamples] = { 1.0196f,  1.0279f, 1.0156f, 1.0388f,  1.0447f,  1.0499f,
...
static float RGBRefl2SpectMagenta[nSpectralSamples] = { 0.9870f, 1.0012f,  1.0177f,  1.0176f, 1.0192f, 1.0025f,
...
static float RGBRefl2SpectYellow[nSpectralSamples] = { -0.0056f, -0.0063f, -0.0054f, -0.0003f, 0.0202f, 0.0850f,
...
static float RGBRefl2SpectRed[nSpectralSamples] = { 0.1209f,  0.1061f,  0.0734f,  0.0320f,  -0.0019f, 0.0114f,
...
static float RGBRefl2SpectGreen[nSpectralSamples] = { -0.0115f, -0.0103f, -0.0115f, -0.0084f, -0.0081f, -0.0055f,
...
static float RGBRefl2SpectBlue[nSpectralSamples] = { 0.9952f, 0.9945f,  0.9935f,  0.9993f,  0.9998f, 0.9991f,
...
static float RGBIllum2SpectWhite[nSpectralSamples] = { 1.1563f, 1.1558f, 1.1563f, 1.1567f, 1.1568f, 1.1568f,
...
static float RGBIllum2SpectCyan[nSpectralSamples] = { 1.1349f,  1.1357f,  1.1357f,  1.1361f,  1.1362f,  1.1364f,
...
static float RGBIllum2SpectMagenta[nSpectralSamples] = { 1.0763f, 1.0770f,  1.0784f,  1.0747f,  1.0730f, 1.0736f,
...
static float RGBIllum2SpectYellow[nSpectralSamples] = { 0.0001f, 0.0002f, -0.0002f, -0.0001f, -0.0002f, 0.0022f,
...
static float RGBIllum2SpectRed[nSpectralSamples] = { 0.0593f,  0.0541f,  0.0455f,  0.0372f,  0.0249f,  0.0080f,
...
static float RGBIllum2SpectGreen[nSpectralSamples] = { 0.0070f, 0.0055f, 0.0007f,  -0.0026f, -0.0153f, 0.0073f,
...
static float RGBIllum2SpectBlue[nSpectralSamples] = { 1.0544f,  1.0543f,  1.0576f,  1.0579f,  1.0582f, 1.0580f,
