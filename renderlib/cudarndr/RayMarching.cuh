...
DEV inline bool
SampleDistanceRM(CRay& R, CRNG& RNG, float3& Ps, const cudaVolume& volumedata)
{
  float MinT;
  float MaxT;
...
DEV inline bool
FreePathRM(CRay& R, CRNG& RNG, const cudaVolume& volumedata)
{
  float MinT;
  float MaxT;
  float3 Ps;
...
DEV inline bool
NearestIntersection(CRay R, const cudaVolume& volumedata, float& T)
{
