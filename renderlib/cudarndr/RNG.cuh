...
{
public:
  DEV CRNG(unsigned int* pSeed0, unsigned int* pSeed1)
  {
    m_pSeed0 = pSeed0;
    m_pSeed1 = pSeed1;
  }
  ...
  DEV float2 Get2(void) { return make_float2(Get1(), Get1()); }

  DEV float3 Get3(void) { return make_float3(Get1(), Get1(), Get1()); }
