...
struct Histogram
{
  ...
  static const float HISTOGRAM_RANGE_PCT_LOW;  // default 0.1% - filter out extreme low outliers
  static const float HISTOGRAM_RANGE_PCT_HIGH; // default 99.9% - filter out extreme high outliers
