  ...
  : prtyObject()
{
  ...
  m_topIntensityUIInfo = new ColorWithIntensityUiInfo(
    &m_skylightDataObject.TopColor, &m_skylightDataObject.TopIntensity, "Intensity", "Top");
  //  m_topIntensityUIInfo = new FloatSliderSpinnerUiInfo(&m_skylightDataObject.TopIntensity, "Intensity", "Top
  //  Intensity");
  ...
  m_middleIntensityUIInfo = new ColorWithIntensityUiInfo(
    &m_skylightDataObject.MiddleColor, &m_skylightDataObject.MiddleIntensity, "Intensity", "Mid");
  ...
  m_bottomIntensityUIInfo = new ColorWithIntensityUiInfo(
    &m_skylightDataObject.BottomColor, &m_skylightDataObject.BottomIntensity, "Intensity", "Bot");
