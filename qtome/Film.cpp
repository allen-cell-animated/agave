...
void
QFilm::SetWidth(const int& Width)
{
  m_Width = Width;
  m_Dirty = true;
...
void
QFilm::SetHeight(const int& Height)
{
  m_Height = Height;
  m_Dirty = true;
...
void
QFilm::SetExposure(const float& Exposure)
{
  m_Exposure = Exposure;
  emit Changed(*this);
}
...
void
QFilm::SetExposureIterations(const int& ExposureIterations)
{
...
void
QFilm::SetNoiseReduction(const bool& NoiseReduction)
{
