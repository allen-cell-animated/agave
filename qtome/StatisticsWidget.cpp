...
void QStatisticsWidget::set(CStatus* status) {
	// TODO this does not disconnect the previous.
	connect(status, SIGNAL(StatisticChanged(const QString&, const QString&, const QString&, const QString&, const QString&)), this, SLOT(OnStatisticChanged(const QString&, const QString&, const QString&, const QString&, const QString&)));
